        ...
        <NavBar
          ...
          title={
            <Block flex row shadow style={{ paddingLeft: 30 }}>
              ...
              />
              <Text size={18} style={{ fontWeight: 'bold', paddingRight: 0, paddingTop: 0, color: scheme === 'dark' ? 'white' : 'black' }}> {'Task Detail'}</Text>
            </Block>
          }
  ...
  render() {
    ...
    return (
      <>
        ...
        {/* <Tab.Navigator>
          <Tab.Screen name="Detail" children={() => <AddTaskScreen {...this.props} />} />
          {this.props.route.params.taskData.ServiceNodeType == 30 || this.props.route.params.taskData.ServiceNodeType == 15 ?
            <Tab.Screen name="Quote" children={() => <QuoteScreen {...this.props} />} />
            : null}
          <Tab.Screen name="Messages" children={() => <TaskMessages {...this.props} />} />
        </Tab.Navigator> */}
      </>
