...
export default class TaskMessages extends React.Component {
  ...
  movemessagedetail() {
    ...
    navigation.navigate("TaskMessageDetail", {
      ...
      taskItem: this.props.route.params.taskData,
  ...
  async refreshData() {
    ...
    requestTaskMessageModel.ModuleID =
      this.props.route.params.pageData.ModuleID;
    ...
    if (this.props.route.params.item.RowID) {
      ...
      requestTaskMessageModel.ActionRowID = this.props.route.params.item
        .ActionRowID
        ? this.props.route.params.item.ActionRowID
        : this.props.route.params.item.RowID;
    } else {
              ...
              <Block flex style={styles.productDescription}>
                <Block flex row space="between">
                  <Block flex style={{ marginTop: 10, marginBottom: 10 }}>
                    <Text size={13} style={styles.textcolor}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", textAlign: "right" }}>
              <TouchableOpacity
                ...
                onPress={() => this.movemessagedetail()}
              >
                <Icon
                  size={24}
                  style={{
