        ...
        <NavBar
          ...
          title={
            <Block flex row shadow style={{ paddingLeft: 30 }}>
              ...
              />
              <Text size={18} style={{ fontWeight: 'bold', paddingRight: 0, paddingTop: 5, color: scheme === 'dark' ? 'white' : 'black' }}> {'Notification'}</Text>
            </Block>
          }
      ...
      <View>
        ...
        <ScrollView
          ...
          <Block flex style={{ paddingLeft: 30, paddingTop: 15 }}>
            ...
            <Text size={14} bold color={scheme === "dark" ? '#c7c5bd' : "#181818"} style={{ paddingTop: 10 }}>{'Send Notification'}</Text>
          </Block>
          <Block flex style={styles.notification}>
            ...
            <Block flex={1} center space="between">
              ...
              <Block center>
                <Text size={14} bold color={scheme === "dark" ? '#c7c5bd' : "#181818"} style={{ paddingTop: 10 }}>{this.state.deviceToken}</Text>
                <Input
                  bgColor='transparent'
              ...
              <Block flex top style={{ marginTop: 20 }}>
                {this.state.capturedPhoto ? <Image source={{ uri: this.state.capturedPhoto }} style={{ width: 150, height: 150 }} /> : null}
                ...
                >
                  {this.state.isProcessing ? 'Please Wait' : 'Send Notificaiton'}
