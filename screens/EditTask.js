        ...
        <NavBar
          ...
          title={
            <Block flex row shadow style={{ paddingLeft: 30 }}>
              ...
              <Text
                size={18}
                style={{ fontWeight: "bold", paddingRight: 0, paddingTop: 5 }}
              >
                {" "}
                Edit Task
              </Text>
      ...
      <View>
        ...
        >
          <Block flex style={{ paddingLeft: 30, paddingTop: 15 }}>
            ...
            >
              <Text size={18} bold color={theme.COLORS.BLACK}>
                Select Category
              </Text>
            </TouchableOpacity>
            <Text
              ...
              style={{ paddingTop: 10 }}
            >
              {"Secure Shredding>Onsite Shredding> Ad hoc request"}
            </Text>
            <Text
              size={14}
              bold
            ...
            <Block flex={1} center space="between">
              <Block center>
                <Input
                  ...
                  color="black"
                  value={
                    "Building Permit request for Rack & Sprinkler installation whs 7"
                  }
                  placeholder="Title"
                  autoCapitalize="none"
                  style={[styles.input]}
                ...
                <Textarea
                  ...
                  defaultValue={
                    "Building Permit required for Rack & Sprinkler installation whs 7 Please contact Tom Williams for further information PH:0428194940"
                  }
                  maxLength={500}
