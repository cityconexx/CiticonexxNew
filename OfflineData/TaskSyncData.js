...
const setupTaskAsync = async (clientAppId, rowid, json, ismetadata, isstatus) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from tasks where clientAppId = ? and rowid = ?', [clientAppId, rowid]);
      tx.executeSql('insert into tasks (clientAppId,rowid, ismetadata, isstatus, json) values (?,?,?,?,?)', [clientAppId, rowid, ismetadata, isstatus, JSON.stringify(json)]);
    },
      (t, error) => { console.log("db error inserttask"); console.log(error); resolve() },
      (t, success) => { resolve(success); console.log("task saved" + rowid); }
    )
  })
}
const setupTaskStatusAsync = async (clientAppId, rowid, json, isstatus) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from tasks where clientAppId = ? and isstatus = ?', [clientAppId, isstatus]);
      tx.executeSql('insert into tasks (clientAppId,rowid, isstatus, json) values (?,?,?,?)', [clientAppId, rowid, isstatus, JSON.stringify(json)]);
    },
      (t, error) => { console.log("db error insert status task"); console.log(error); resolve() },
      (t, success) => { resolve(success); console.log("task status saved" + rowid); }
    )
  })
}
...
const DeleteTaskAsync = async (rowid) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      ...
      (t, error) => { console.log("db error delete task"); console.log(error); resolve() },
      (t, success) => { resolve(success); console.log("task deleted" + rowid); }
    )
  })
}
...
const setupTaskDetailAsync = async (clientAppId, rowId, json) => {
  ...
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from taskDetail where id = ?', [rowId]);
      tx.executeSql('insert into taskDetail (clientAppId, RowId, json) values (?,?,?)', [clientAppId, rowId, json]);
    },
      (t, error) => { console.log("db error inserttaskdetail"); console.log(error); resolve() },
      (t, success) => { resolve(success); console.log('inserted rowid ' + rowId); }
    )
  })
}
...
const DeleteTaskDetailAsync = async (clientAppId) => {
  ...
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from taskDetail where clientAppId = ?', [clientAppId]);
      //tx.executeSql( 'insert into taskDetail (clientAppId, json) values (?,?)', [clientAppId, json] );
    },
      (t, error) => { console.log("db error deletetaskdetail"); console.log(error); resolve() },
...
const getTaskDetailAsync = async (rowId) => {
  ...
  return new Promise((resolve, reject) => {
    db.transaction(
      ...
      (t, error) => { console.log("db error load taskDetail"); console.log(error) },
      (_t, _success) => { console.log("loaded taskDetail completed"); }
    );
  });
      ...
      tx => {
        tx.executeSql(
          ...
          (_, { rows: { _array } }) => {
            ...
            if (_array.length > 0)
              taskData = JSON.parse(_array[0].json);
...
const setupTaskActivityAsync = async (groupAppId, json) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      ...
      (t, error) => { console.log("db error activityJSON"); console.log(error); resolve() },
      (t, success) => { resolve(success); }
    )
  })
}
...
const setupTaskDLLAsync = async (groupAppId, json) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      ...
      tx.executeSql('insert into taskDLL (groupAppId, json) values (?,?)', [groupAppId, JSON.stringify(json)]);
    },
      (t, error) => { console.log("db error taskDLL"); console.log(error); resolve() },
      (t, success) => { resolve(success); }
    )
  })
}
...
const setPagingDeltaDataAsync = async (json, reportId) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from pagingdeltadata WHERE reportId = ? ', [reportId]);
      tx.executeSql('insert into pagingdeltadata (reportId,json) values (?,?)', [reportId, JSON.stringify(json)]);
    },
      (t, error) => { console.log("db error inserttask"); console.log(error); resolve() },
      (t, success) => { resolve(success) }
    )
...
const setSaveTaskDataAsync = async (timestamp, json) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('insert into savetask (timestamp, json) values (?,?)', [timestamp, JSON.stringify(json)]);
    },
      (t, error) => { console.log("db error save local task"); console.log(error); resolve() },
      (t, success) => { resolve(success) }
    )
  })
}
...
const DeleteSaveTaskDataAsync = async (timestamp) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      ...
      (t, error) => { console.log("db error delete task local"); console.log(error); resolve() },
      (t, success) => { resolve(success) }
    )
  })
}
...
const saveTaskCategoryToLocal = async (groupAppId, json) => {
  return new Promise((resolve, _reject) => {
    db.transaction(tx => {
      tx.executeSql('delete from tabletaskCategory where group_id = ?', [groupAppId], () => {
      ...
      json.map(item => {
        ...
        tx.executeSql('insert into tabletaskCategory (group_id, server_id, category_text, cat_json) values (?,?,?,?)', [groupAppId, item.ID, item.text, JSON.stringify(item)], (tx, rs) => {
      ...
      (t, error) => { console.log("insert error tabletaskCategory "); resolve() },
      (t, success) => { resolve(success); }
    )
  })
}
...
const getTaskCategoryFromLocal = async (groupAppId) => {
  return new Promise((resolve, reject) => {
    db.transaction(
      ...
      (t, error) => { console.log("get db error TaskCategoryFromLocal " + groupAppId); reject('error ' + error); },
      (_t, _success) => { console.log("loaded messages " + groupAppId); }
    );
  });
...
const dropTable = async () => {
  return new Promise((resolve, reject) => {
    db.transaction(
      ...
      (t, error) => { console.log("dropTable error "); reject(''); },
      (_t, _success) => { console.log("dropTable "); }
    );
  });
}
